...
PARAM$finalmodel$num_iterations <- 185
PARAM$finalmodel$learning_rate <- 0.055965307
PARAM$finalmodel$feature_fraction <- 0.5947975
PARAM$finalmodel$min_data_in_leaf <- 1389
