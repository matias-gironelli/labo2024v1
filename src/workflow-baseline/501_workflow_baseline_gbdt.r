...
TS_strategy_guantesblancos_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  # Atencion  0.1  de  undersampling de la clase mayoritaria,  los CONTINUA
  # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA
  param_local$train$undersampling <- 0.2 # elijo quedarme con el 50%, de los CONTINUA, deberÃ­a ser buena estimaciÃ³n.
...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    min_data_in_leaf = c( 100L, 2000L, "integer" ) # IMPORTANTE, ACÃ DEBERÃA SER MENOS DE 100, NOSE XQ LO DEJARON
  )
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT00012", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA00012", "DT00012" )
  
  DR_drifting_guantesblancos( "DR00012", "CA00012" )
  FE_historia_guantesblancos( "FE00012", "DR00012" )
  
  TS_strategy_guantesblancos_202109( "TS00012", "FE00012" )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS00022", "FE00012" )
